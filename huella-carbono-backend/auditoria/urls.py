...
from .analytics_views import AnalyticsOverviewView, CarbonFootprintAnalyticsView
...
from .ubicaciones_views import UbicacionesView
...
urlpatterns = [
    ...
    path('ubicaciones/', UbicacionesView.as_view(), name='ubicaciones'),
